        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonDebtId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonDebtHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PersonDebtHistories_Persons_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonDebts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PersonDebts_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonIbans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PersonIbans_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonDebtHistories_PersonId",
                table: "PersonDebtHistories",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonDebts_PersonId",
                table: "PersonDebts",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonIbans_PersonId",
                table: "PersonIbans",
                column: "PersonId");
